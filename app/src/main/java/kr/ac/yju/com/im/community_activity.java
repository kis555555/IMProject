...
public class community_activity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mWebView.postUrl("http://101.101.162.32:8080/Mlogin.jsp", EncodingUtils.getBytes(postData, "BASE64"));
    }

    // 백 키를 눌렀을 시 경고창을 띄움
    public void onBackPressed()
    {
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(community_activity.this);
