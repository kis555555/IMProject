...
public class Myprofile_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton pro_pic_set = (ImageButton)findViewById(R.id.myprofile_picture_setting);
        ...
        pro_pic_set.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotopropic = new Intent(getApplicationContext(), Profile_Picture_Activity.class);
                startActivity(gotopropic);
            }
        });
